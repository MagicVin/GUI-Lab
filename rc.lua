...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "g",     function () awful.util.spawn("chromium-browser") end,
              {description = "chrome", group = "app"}),

    -- Full ScreenCapture
    awful.key({}, "Print",   function () awful.util.spawn_with_shell("eta.sh Screen_Capture full") end,
              {description = "full screencapture", group = "app"}),

    -- part ScreenCapture
    awful.key({ modkey }, "Print",   function () awful.util.spawn_with_shell("eta.sh Screen_Capture part") end,
              {description = "part of screencapture", group = "app"}),

    -- file management
    awful.key({ modkey }, "F12",   function () awful.util.spawn("pcmanfm") end,
              {description = "file management", group = "app"}),

    -- bright screen
    awful.key({}, "F5",   function () awful.util.spawn_with_shell("eta.sh Screen_TuneLight light") end,
              {description = "bright screen", group = "app"}),

    -- dim screen
    awful.key({}, "F6",   function () awful.util.spawn_with_shell("eta.sh Screen_TuneLight dim") end,
              {description = "dim screen", group = "app"}),
    ...
    -- User customization
    awful.key({},"F12", function() awful.util.spawn_with_shell("xscreensaver-command -lock") end) 	      
)
